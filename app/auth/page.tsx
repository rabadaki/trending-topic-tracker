      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900">TrendTracker</h1>
          </div>
          <p className="text-gray-600">Discover trending topics and generate AI-powered content ideas</p>
        </div>
